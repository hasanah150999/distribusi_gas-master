...
DELIMITER //
CREATE FUNCTION `func_temp_rfid`(`data_alat` VARCHAR(250)
...
CREATE TABLE IF NOT EXISTS `tb_agen` (
  ...
  `data_rfid` bigint(20) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_pelanggan` (
  ...
  `data_rfid` varchar(250) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `tb_temp_rfid` (
  ...
  `data_rfid` varchar(250) NOT NULL DEFAULT '0',
  `create_date` datetime NOT NULL,
  PRIMARY KEY (`id`)
